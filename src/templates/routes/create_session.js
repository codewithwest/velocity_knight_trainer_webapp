...
export function CreateSession() {
  ...
  return (
    <>
      ...
      <div class="d-flex w-100 h-100 border">
        <div class="form-cont d-flex">
          <form action="d-flex col">
            <div class="group-inputs">
              <div class="input-cont">
                <input type="text" class="input-area" name="exercise" placeholder="" />
                <label for="exercise">exercise</label>
              </div>
              <div class="input-cont">
                <input type="text" class="input-area input-numbers" inputmode="numeric" name="reps" placeholder="" />
                <label for="exercise">reps</label>
              </div>
              <div class="input-cont">
                <input type="text" class="input-area input-numbers" inputmode="numeric" name="sets" placeholder="" />
                <label for="exercise">Sets</label>
              </div>
            </div>
            <div class="input-cont">
              <textarea class="input-area" name="sets" placeholder=""></textarea>
              <label for="exercise">Session instructions</label>
            </div>
          </form>
        </div>
